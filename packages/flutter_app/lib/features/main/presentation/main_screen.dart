...
import '../../../utils/network_connectivity/network_connectivity.dart';
import '../../../utils/providers/app_lifecycle_provider.dart';
import '../../../utils/providers/locales_provider.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref
      ...
      ..listen(networkConnectionStateProvider.future, (previous, next) async {
        ...
        final prevResults = previous;
        final nextResults = next;
